...
["_malloc","_free","_memory","_fontToJSON","_JSONtoFont","_blob_data","_blob_length","_free_blob","___indirect_function_table","onRuntimeInitialized"].forEach((prop) => {
...
var _free_blob = Module['_free_blob'] = createExportWrapper('free_blob');
